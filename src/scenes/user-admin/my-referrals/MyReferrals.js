    ...
    return (
      <div className="user-admin-my-referrals">
        ...
        <Row>
				...
				<Table pagination={this.state.pagination} loading={this.state.loading} dataSource={this.state.referrals}  scroll={{x:575}}>
					<Column
						title="#"
						dataIndex="key"
						key="key"
...
export default MixpanelTrackWrapper(MyReferrals, 'MyReferrals');