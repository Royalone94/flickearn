    ...
    render() {
        return (
            <div className="user-admin-dashboard">
                ...
                <Table pagination={this.state.pagination} loading={this.state.loading} dataSource={this.state.transactions} scroll={{x:575}}>
                    <Column
                        title="#"
                        dataIndex="key"
                        key="key"
...
export default MixpanelTrackWrapper(Dashboard, 'Dashboard');