...
const defaultMenuItems = [
    ...
    {title: 'Promotion', link: getUserPromotionPath, icon:'http://res.cloudinary.com/sheilafox/image/upload/v1525366315/promotion.png'},
    {
        ...
        subItems: [
            ...
            {title: 'Custom Tasks', link: getUserWorkCustomTasksPath,icon:'http://res.cloudinary.com/sheilafox/image/upload/v1537948526/custom_task.png'},
        ],
    },
